...
<body>
                ...
                <ul class="full-width">
                    ...
                    <li>
                        ...
                        <ul class="full-width">
                            ...
                            <li><a href="typography-shadow.html" class="waves-effect waves-light">Futbol sala</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Baloncesto</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Natación</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Voleybol</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Tenis de mesa</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Ajedrez</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Etletismo</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="#" class="waves-effect waves-light">Futbol</a></li>
                        </ul>   
    ...
    <section class="ContentPage full-width">
       ...
       <!--Input fields-->
        <div class="container">
            <div class="row">
                <h2 class="center-align">Nueva actividad Canto</h2>
                <form class="col s12" name="form_New_activity" method="post" action="CCantoLogica.php" enctype="multipart/form-data">
                    <div class="row">
       ...
       <div class="container">
            <div class="row">
                ...
                <form class="col s12" name="form_New_activity" method="post" action="CMusicaLogica.php">
                    ...
                    <div class="row">
                            <div class="input-field col s12">
                                <textarea id="textarea1" class="materialize-textarea" name="txt_ActuAcTexo" required=""></textarea>
                                <label for="textarea1">Textarea</label>
                            </div>
                    </div>
